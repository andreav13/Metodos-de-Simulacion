...
const double deltat=0.0001, g=1, l=1, m=1;
...
public:
  void Inicie(double Ix, double Iy, double Iz, double theta0, double phi0, double psi0,double wx0, double wy0, double wz0);
  void Rote(double dt);
...
void CuerpoRigido::Inicie(double Ix, double Iy, double Iz, double theta0, double phi0, double psi0,double wx0, double wy0, double wz0){

  //Momento de inercia
  I1=Ix; I2=Iy; I3=Iz;
  //Velocidad angular inicial
  wx=wx0; wy=wy0; wz=wz0;
  //Posicion inicial (en cuaterniones)
...
void CuerpoRigido::CalculeTorque(void){
  //Torques en el sistema rotante pegado al cuerpo (debido al peso)
